...
const BottomNav = ({ currentPage, onNavigate, currentUser }) => {
  ...
  const tabs = [
    ...
    { id: 'account', path: '/account', icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', label: currentUser?.name || currentUser?.identifier || 'Account' }
  ];
